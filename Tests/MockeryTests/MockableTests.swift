...
//                mock.registerResult(for: mock.functionWithIntResult) { _ in 123 }
//                mock.registerResult(for: mock.functionWithStringResult) { _ in "a string" }
//                mock.registerResult(for: mock.functionWithStructResult) { _ in user }
//                mock.registerResult(for: mock.functionWithClassResult) { _ in thing }
//                
...
//                mock.registerResult(for: mock.functionWithIntResult) { _, arg2 in arg2 }
//                mock.registerResult(for: mock.functionWithStringResult) { arg1, _ in arg1 }
//                
//                expect(mock.functionWithIntResult(arg1: "abc", arg2: 123)).to(equal(123))
...
//                let user = User(name: "a user")
//                let thing = Thing(name: "a thing")
//                mock.registerResult(for: mock.functionWithOptionalIntResult) { _ in 123 }
//                mock.registerResult(for: mock.functionWithOptionalStringResult) { _ in "a string" }
//                mock.registerResult(for: mock.functionWithOptionalStructResult) { _ in user }
//                mock.registerResult(for: mock.functionWithOptionalClassResult) { _ in thing }
//                
...
//            
//            it("it can register different return values for different argument values") {
//                mock.registerResult(for: mock.functionWithOptionalIntResult) { _, arg2 in arg2 }
//                mock.registerResult(for: mock.functionWithOptionalStringResult) { arg1, _ in arg1 }
//                
//                expect(mock.functionWithOptionalIntResult(arg1: "abc", arg2: 123)).to(equal(123))
